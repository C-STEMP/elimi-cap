...
const DEFAULT_SECTION_INFO: Record<string, string> = {
  ...
  "Current Occupation": "Specify your current job role or trade discipline and total years of practical work experience.",
  "Employment History": "Provide details of past work history, employers, roles, and key responsibilities in your trade.",
  "Why are you applying for RPL?": "Explain your primary motivation for seeking Recognition of Prior Learning and expected outcomes.",
  "Evidence Summary": "Indicate the supporting documents, work samples, or certificates you can provide as RPL evidence.",
};
...
export const InfoIcon: React.FC<InfoIconProps> = ({
  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div className="absolute left-1/2 -translate-x-1/2 top-full mt-1.5 z-50 w-64 sm:w-72 p-3 bg-[#141B34] text-white text-xs rounded-xl shadow-xl border border-[#2A3454] leading-relaxed animate-in fade-in zoom-in-95 duration-150 select-text pointer-events-none">
