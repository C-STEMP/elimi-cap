...
import { CANDIDATE_NAV_LINKS, CANDIDATE_ROUTES } from "@/features/candidate/utils/candidateRoutes";

const NAV_LINKS = CANDIDATE_NAV_LINKS;
  ...
  return (
    <nav className="flex items-center justify-between px-6 lg:px-10 py-4 relative">
      ...
      <div className="flex items-center gap-4">
        ...
        <a
          href={CANDIDATE_ROUTES.app.settings}
